  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        ...
        <title>NetShade Scan Report Nmap <xsl:value-of select="/nmaprun/@version"/></title>
      </head>
      <body>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1>NetShade Scan Report<br/><small>Nmap <xsl:value-of select="/nmaprun/@version"/></small></h1>
